...
namespace BarCodeSystem
{
    public class User_Info
    {
        ...
        //public static string[] server = { "172.16.100.123", "172.16.100.53", "172.16.100.40" };
        public static string[] server = { "172.16.100.123", "172.16.100.40" };
        //U9测试库；条码测试库；

        //public static string[] database = { "sanhuadata20131011", "fajianBarCodeSystem", "BarCodeSystem" };
        ...
        //public static string[] pwd = { "Aa1", "Ab123456", "Bb123" };
